...
class RandomGraphFactory {
 public:
  ...
  [[nodiscard]] BAGraph createBarabasiAlbertWithPreferentialAttachmentRepeatedNodes(size_t initial_nodes_number,
                                                                                    size_t final_nodes_number,
                                                                                    size_t edges_per_new_node_number,
                                                                                    GraphPainter* painter = nullptr);

  [[nodiscard]] BAGraph createBarabasiAlbertWithPreferentialAttachmentBatageljBrandes(size_t initial_nodes_number,
                                                                                      size_t final_nodes_number,
                                                                                      size_t edges_per_new_node_number,
                                                                                      GraphPainter* painter = nullptr);
